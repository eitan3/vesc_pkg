...
#define APPCONF_BALANCE_PITCH_TH 30
#endif

// Pitch Throttle (B)
#ifndef APPCONF_BALANCE_PITCH_TH_B
#define APPCONF_BALANCE_PITCH_TH_B 15
#endif
...
#define APPCONF_BALANCE_PITCH_THI 0.05
#endif

// Pitch Throttle Integral (B)
#ifndef APPCONF_BALANCE_PITCH_THI_B
#define APPCONF_BALANCE_PITCH_THI_B 0.001
#endif

// Pitch Throttle Integral (C)
#ifndef APPCONF_BALANCE_PITCH_THI_C
#define APPCONF_BALANCE_PITCH_THI_C 0.05
#endif

// Gyro Throttle
#ifndef APPCONF_BALANCE_GYRO_TH
#define APPCONF_BALANCE_GYRO_TH 0.5
#endif

// Gyro Throttle (B)
#ifndef APPCONF_BALANCE_GYRO_TH_B
#define APPCONF_BALANCE_GYRO_TH_B 0.1
#endif

// Gyro Throttle (C)
#ifndef APPCONF_BALANCE_GYRO_TH_C
#define APPCONF_BALANCE_GYRO_TH_C 0.5
#endif
...
#define APPCONF_BALANCE_CURRENT_OUT_FILTER_B 0.25
#endif
...
#define APPCONF_BALANCE_PITCH_THI_LIMIT_B 20
#endif
...
#define APPCONF_BALANCE_TUNEA_TRANSITION_SPEED 6
#endif
...
#define APPCONF_BALANCE_ASYM_MAX_ACCEL_B 2.25
#endif
...
#define APPCONF_BALANCE_FAULT_DELAY_PITCH 150
#endif

// Roll Fault Delay
#ifndef APPCONF_BALANCE_FAULT_DELAY_ROLL
#define APPCONF_BALANCE_FAULT_DELAY_ROLL 150
#endif
...
#define APPCONF_BALANCE_TILTBACK_LV_ANGLE 8
#endif
...
#define APPCONF_BALANCE_TORQUETILT_START_CURRENT_B 5
#endif

// Tilitback Angle Limit
#ifndef APPCONF_BALANCE_TORQUETILT_ANGLE_LIMIT
#define APPCONF_BALANCE_TORQUETILT_ANGLE_LIMIT 3
#endif
...
#define APPCONF_BALANCE_TORQUETILT_STRENGTH 0.25
#endif

// Strength (Regen)
#ifndef APPCONF_BALANCE_TORQUETILT_STRENGTH_REGEN
#define APPCONF_BALANCE_TORQUETILT_STRENGTH_REGEN 0.15
#endif

// Current Filter
#ifndef APPCONF_BALANCE_TORQUETILT_FILTER
#define APPCONF_BALANCE_TORQUETILT_FILTER 5
#endif
...
#define APPCONF_BALANCE_ROLL_TURNTILT_ANGLE_LIMIT 5
#endif

// Roll Angle Threshold
#ifndef APPCONF_BALANCE_ROLL_TURNTILT_START_ANGLE
#define APPCONF_BALANCE_ROLL_TURNTILT_START_ANGLE 1
#endif

// ERPM Threshold
#ifndef APPCONF_BALANCE_ROLL_TURNTILT_START_ERPM
#define APPCONF_BALANCE_ROLL_TURNTILT_START_ERPM 100
#endif

// Max Tiltback Speed
#ifndef APPCONF_BALANCE_ROLL_TURNTILT_SPEED
#define APPCONF_BALANCE_ROLL_TURNTILT_SPEED 5
#endif
...
#define APPCONF_BALANCE_ROLL_TURNTILT_ERPM_BOOST_END 20000
#endif
...
#define APPCONF_BALANCE_YAW_TURNTILT_STRENGTH 4
#endif

// Tilitback Angle Limit
#ifndef APPCONF_BALANCE_YAW_TURNTILT_ANGLE_LIMIT
#define APPCONF_BALANCE_YAW_TURNTILT_ANGLE_LIMIT 2
#endif
...
#define APPCONF_BALANCE_YAW_TURNTILT_START_ERPM 100
#endif

// Max Tiltback Speed
#ifndef APPCONF_BALANCE_YAW_TURNTILT_SPEED
#define APPCONF_BALANCE_YAW_TURNTILT_SPEED 3
#endif
...
#define APPCONF_BALANCE_YAW_TURNTILT_ERPM_BOOST_END 20000
#endif
...
#define APPCONF_BALANCE_BOOSTER_BASE 0
#endif
...
#define APPCONF_BALANCE_BOOSTER_LIMIT 0
#endif
...
#define APPCONF_BALANCE_BOOSTER_BASE_B 0
#endif
...
#define APPCONF_BALANCE_BOOSTER_LIMIT_B 0
#endif
...
#define APPCONF_BALANCE_BOOSTER_BASE_C 0
#endif
...
#define APPCONF_BALANCE_BOOSTER_LIMIT_C 0
#endif
